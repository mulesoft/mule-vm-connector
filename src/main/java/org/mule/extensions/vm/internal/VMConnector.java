 ...
 *
 * Transient queues are faster, but not reliable in the case of a system crash. Transient queues,
 ...
 * in cluster mode, persistent queues are not backed by the memory grid instead. This means that when a flow uses the VM connector
 ...
 *
 * In either way, transactions are always optionally supported.  
 *
 * @since 1.0
 */
@Extension(name = "VM")
